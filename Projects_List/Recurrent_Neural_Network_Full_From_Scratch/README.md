...
## Inference Code
Here is the inference code to test our trained model:
```python
import json
from RecurrentNeuralNetworkFullFromScratch import RecurrentNeuralNetwork
...
## Full Code
Here is the full code with train and inference code:
```python
# IMPORT PRE-BUILT MODULES
import random
import math
